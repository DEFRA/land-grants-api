...
const validResourceTypes = ['parcels', 'moorland', 'covers', 'agreements', 'compatibility-matrix']
...
if (validResourceTypes.includes(resourceType) && filepath) {
    ...
    console.error(`Invalid resource type: ${resourceType} or file path: ${filepath}`)
    process.exit(1)
}