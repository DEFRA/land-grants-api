...
import { getActionsForParcel } from '~/src/api/parcel/service/parcel.service.js'
import { createCompatibilityMatrix } from '~/src/available-area/compatibilityMatrix.js'
import { getDataAndValidateRequest } from '~/src/api/parcel/validation/1.0.0/parcel.validation.js'
import { vi } from 'vitest'

vi.mock('~/src/api/parcel/validation/1.0.0/parcel.validation.js')
...
describe('Parcels Controller 1.0.0', () => {
