/**
 * @import { CaseManagementValidationResponse, StatusComponent, HeadingComponent, ParagraphComponent, DetailsComponent, ValidationComponent, DetailsSummaryItem } from '~/src/features/case-management-adapter/case-management-adapter.d.js'
 * @import { ApplicationValidationRun, ActionResult, RuleResult } from '~/src/features/application/application.d.js'
