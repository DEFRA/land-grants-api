 ...
 * @property {string} [guidanceLink]
 * @property {'total'|'partial'|'limited'} [availableAreaType] - Governs how the user must enter a value relative to availableArea: 'total' requires the full amount, 'partial' allows any amount up to and including the total, 'limited' allows an amount capped below the total. Values are defined in src/features/common/constants/action_metadata.js.
 */
