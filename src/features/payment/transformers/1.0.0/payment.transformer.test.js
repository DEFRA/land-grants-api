import { paymentCalculationTransformerV1 } from './payment.transformer.js'

describe('paymentCalculationTransformerV1', () => {
  test('should remove semanticVersion and preserve existing version field', () => {
    const response = {
      parcelItems: {
        1: {
          code: 'UPL1',
    ...
    const result = paymentCalculationTransformerV1(response)
    ...
    expect(result.parcelItems[2].version).toBe(1)
