INSERT INTO public.actions (version, enabled, display, start_date, code, description, application_unit_of_measurement, payment, land_cover_class_codes, rules, last_updated) 
VALUES
(
    1, 
    TRUE, 
