      ...
      'should return 2 stack when 2 actions and area when the second action is smaller',
      {
        ...
        expectedResult: {
          explanations: {
            title: 'Stacks',
            content: [
              'Stack 1 - CMOR1, UPL1 - 0.0008 ha',
              'Stack 2 - UPL1 - 0.0001 ha',
              '',
              'Explanation:',
      ...
      'should return 2 stack when 2 actions and area when the actions are not compatible',
      {
        ...
        expectedResult: {
          explanations: {
            title: 'Stacks',
            content: [
              'Stack 1 - UPL2 - 0.0008 ha',
              'Stack 2 - UPL1 - 0.0009 ha',
              '',
              'Explanation:',
      ...
      'should return 3 stacks when all actions are compatible',
      {
        ...
        expectedResult: {
          explanations: {
            title: 'Stacks',
            content: [
              'Stack 1 - A, C, B - 0.0003 ha',
              'Stack 2 - C, B - 0.0005 ha',
              'Stack 3 - B - 0.0001 ha',
              '',
              'Explanation:',
              'Adding A (area 0.0003 ha)',
      ...
      'should return 3 stacks when some actions are compatible',
      {
        ...
        expectedResult: {
          explanations: {
            title: 'Stacks',
            content: [
              'Stack 1 - A, C - 0.0003 ha',
              'Stack 2 - B, C - 0.0006 ha',
              'Stack 3 - B - 0.0002 ha',
              '',
              'Explanation:',
              'Adding A (area 0.0003 ha)',
      ...
      'CIPM4: Real world example',
      {
        ...
        expectedResult: {
          explanations: {
            ...
            content: [
              'Stack 1 - SW1 - 0.46 ha',
              'Stack 2 - AB1, PRF1, SOH1, CSAM1 - 0.5 ha',
              'Stack 3 - PRF1, SOH1, CSAM1 - 8.2218 ha',
              'Stack 4 - SOH1, CSAM1 - 0.46 ha',
              'Stack 5 - CSAM1 - 0.1737 ha',
              '',
              'Explanation:',
