...
aws --endpoint-url=http://localhost:4566 s3 cp ingestion-data/moorland-exceptions_1.csv s3://land-data/moorland-exceptions/85c49b7d-cceb-434c-aa5b-f532ad1b12f9.csv
```
