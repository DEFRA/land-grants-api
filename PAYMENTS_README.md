...
| marketingYear              | number  | Yes      | Scheme year for request (2021-2099)                   | We will move away from scheme years - We'll have to talk about this one, we might need something more flexible and might need work on Payment Hub side too. We'll need to check the different scenarios with PPA adjustments to figure out how to use this parameter. | 2022                                 |
